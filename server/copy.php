...
$query = 'SELECT * FROM pdf_user_information WHERE Account=\'' . $account_receive . '\'' .'and path=\'' . $path_receive . '\'';
$result = mysqli_query($database,$query);
$row = mysqli_fetch_array($result);
$name_receive = '(C)' . $row['name'];
$tag_receive = $row['tag'];
$path_receive_process = str_replace($row['name'],$name_receive,$path_receive) ;
...
VALUES ('$account_receive','$path_receive_process','$name_receive','$tag_receive','$data_receive')")){
